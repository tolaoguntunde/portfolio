...
<div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
    ...
    <div className="flex justify-center">
        <a href="www" className="inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 duration-200" >Purchase</a>
    </div>
    </div>
...
<div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
    ...
    <div className="flex justify-center">
        <a href="www" className="inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg bg-violet-800 hover:bg-violet-800 hover:border-violet-800 duration-200" >Purchase</a>
    </div>
    </div>
<div className="border-t border-slate-700"></div>
<div className="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
